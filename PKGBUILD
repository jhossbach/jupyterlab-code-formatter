...
makedepends=(python-build python-installer python-hatchling python-hatch-jupyter-builder python-hatch-nodejs-version python-types-python-dateutil python-rfc3986-validator)
